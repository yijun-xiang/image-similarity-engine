  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gradient-to-r from-blue-600/10 via-purple-600/10 to-pink-600/10 backdrop-blur-xl rounded-2xl p-6 mb-8 border border-white/20 dark:border-gray-700/50"
      >
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            <motion.div
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm rounded-xl"
            >
            ...
            {results.cached && (
              <motion.div
                ...
                animate={{ scale: 1 }}
                whileHover={{ scale: 1.05 }}
                className="flex items-center space-x-2 px-4 py-2 bg-green-500/20 backdrop-blur-sm rounded-xl"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {results.results.map((result, index) => (
            ...
            >
              ...
              <div className="relative bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-white/20 dark:border-gray-700/50 hover:border-white/40 dark:hover:border-gray-600/50 transition-all">
