...
echo "Step 4: Updating task definition with all services..."
cat > /tmp/backend-production-task.json << BACKEND_EOF
{
...
aws ecs register-task-definition --cli-input-json file:///tmp/backend-production-task.json --region $REGION
...
echo ""
echo "Test endpoints:"
echo "Health: curl https://image-similarity-alb-691234645.us-west-2.elb.amazonaws.com/api/v1/health"
echo "Stats: curl https://image-similarity-alb-691234645.us-west-2.elb.amazonaws.com/api/v1/stats"
