...
from app.core.metrics import track_ml_inference, ml_inference_total
...
class MLService:
    ...
    @track_ml_inference("clip-vit-b32", "extract_features")
    ...
    @track_ml_inference("clip-vit-b32", "batch_extract_features")
